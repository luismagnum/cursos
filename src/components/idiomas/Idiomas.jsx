    ...
    return (
      <div className='text-center mx-auto mt-10 md:mt-20 mb-20 px-4 md:px-8'>
        <h1 className='text-3xl text-sky-900 font-bold mb-4'>Curso de Idiomas</h1>
         <h2 className="text-xs text-sky-950 font-bold">...Que el idioma no sea una barrera en tu carrera.</h2>
         <h2 className="text-xs text-sky-950 font-bold">Aprende con nuestros profesores nativos</h2>
